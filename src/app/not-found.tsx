...
export default function NotFound() {
  return (
    <main className="relative min-h-screen flex items-center justify-center p-6 text-(--color-text-primary) overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-2xl mx-auto">
        ...
        <motion.p
          ...
          className="text-(--color-text-secondary) text-lg mb-10 leading-relaxed font-light italic"
        >
        ...
        >
          <Link
            href="/"
            className="group relative inline-flex items-center justify-center gap-2 px-8 py-4 bg-(--color-text-primary) text-(--color-bg-primary) font-bold rounded-2xl transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-(--color-text-primary)/20 overflow-hidden uppercase tracking-wider text-sm"
          >
          ...
          <button
            ...
            className="group px-8 py-4 rounded-2xl glass-card border border-(--color-border) font-bold text-sm uppercase tracking-wider hover:bg-(--color-bg-secondary) transition-all flex items-center gap-2"
          >
